...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-around.align-items-center
        ...
        p A continuación, se abordan distintos tipos de arquitecturas relacionadas a los sistemas operativos que trabajan bajo ordenadores con características específicas, de acuerdo con la tecnología que utilizan.
    ...
    .row.justify-content-around.align-items-center
        ...
        p #[strong  En la arquitectura de <i>software</i> podemos encontrar:]

        .col-6.tarjetas-arquitectura-software
    ...
    .row.tarjeta.tarjeta--blanca.p-2.p-md-3
      ...
      p Aprendiz, observe el siguiente video para ampliar la información sobre este tema.
      br
      br
    ...
    .row.justify-content-around.align-items-center
      ...
      .titulo-segundo.color-acento-contenido
        h2 2.2  Plan de contingencia
      
      .row.bloque1-sistemas-distribuidos
          .col-7
    ...
    .row.justify-content-around.align-items-center
      ...
      .col-6
        //No puse el fade up en el ultimo elemento porque bloquea la pagina
        figure
